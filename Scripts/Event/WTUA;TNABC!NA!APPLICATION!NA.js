...
if (currentUserID.equals("AF03304")){
	showDebug=true;
	showMessage=true;
}
...
{
if (wfTask.equals("Investigative Review") && wfStatus.equals("Denied") && isTaskActive("Citizenship Verification")){ branchTask ("Citizenship Verification", "Denied", "Investigative Review was Denied")};
if (wfTask.equals("Citizenship Verification") && wfStatus.equals("Denied") && isTaskActive("Investigative Review")){ branchTask ("Investigative Review", "Denied", "Citizenship Verification was Denied")};
}
